...
export default function InvoicingPage() {
  ...
  useEffect(() => {
    // Simulamos varias facturas con diferentes fechas
    const mockInvoices: Invoice[] = [
      ...
      {
        id: 'INV-' + (Date.now() - 86400000), // 1 día antes
      ...
      {
        id: 'INV-' + (Date.now() - 172800000), // 2 días antes
        date: new Date(Date.now() - 172800000).toLocaleDateString(),
        items: [
          { name: 'Auriculares Bluetooth', price: 150, quantity: 1 },
          { name: 'Cargador USB-C', price: 20, quantity: 3 }
        ],
        subtotal: 210,
        tax: 25.2,
        total: 235.2
